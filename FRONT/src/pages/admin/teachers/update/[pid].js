     ...
     useEffect(() => {
      ...
      const handleUpdateTeacher = async () => {
        try {
          ...
          setMensage( { message: "Professor editado com sucesso!" , status: "ok"} );      
        } catch (error) {
      ...
      <div className="d-flex justify-content-center p-2">
        <div className="container">
            <div className="row border-bottom fw-bold">
                <h3 className="text-center fw-bold"> EDITAR PROFESSOR </h3>
                ...
                <div className="form-group p-2">
                    <button className="btn btn-success fw-bold mx-1" type="button" onClick={handleUpdateTeacher} >SALVAR</button>
