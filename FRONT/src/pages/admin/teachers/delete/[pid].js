  ...
  const optionsStatus = [
    ...
    useEffect(() => {
      ...
      try {
          ...
          setMensage({ message: "Professor encontrado", status: "ok" }); 
          setTeacher(response.data.foundedTeacher);
      } catch (error) {
          console.error("Erro ao buscar o professor:", error);
          setMensage({ message: "Erro ao buscar o Professor!", status: "error" });
      }
    };
    ...
    const handleDeleteTeacher = async () => {
      ...
      setMensage({ message: "Erro ao deletar o Professor!", status: "error" });
    }
  };
      ...
      <div className="d-flex justify-content-center p-2">
        <div className="container">
            <div className="row border-bottom fw-bold">
                <h3 className="text-center fw-bold"> DELETAR PROFESSOR </h3>
                ...
                <div className="form-group p-2">
                    <button className="btn btn-danger fw-bold mx-1" type="button" onClick={handleDeleteTeacher} >DELETAR</button>
                    <Link className="btn btn-secondary fw-bold mx-1" href="/admin/teachers">VOLTAR</Link>
                </div>
                </form>
            </div>
        </div>
