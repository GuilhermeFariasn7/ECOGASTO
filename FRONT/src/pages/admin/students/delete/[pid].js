  ...
  const optionsStatus = [
    ...
    useEffect(() => {
      ...
      try {
          ...
          setMensage({ message: "Erro ao buscar o Estudante!", status: "error" });
      }
    };
      ...
      <div className="d-flex justify-content-center p-2">
        <div className="container">
            <div className="row border-bottom fw-bold">
                <h3 className="text-center fw-bold"> DELETAR ESTUDANTE </h3>
                ...
                <div className="form-group p-2">
                    <button className="btn btn-danger fw-bold mx-1" type="button" onClick={handleDeleteStudent} >DELETAR</button>
